                ...
                <div className='row mx-auto text-center footer pt-5'>
                    ...
                    <div className='col-lg-3 mx-auto team'>
                        ...
                        <ul>
                            <li>
                                ...
                                <p>I'm persuing my B.Tech degree in Computer Science and Engineering from one of the pretigious college of India VIT Bhopal and live in UttarPradesh, India.</p>
                            </li>
                            <li>
                                <p style={{fontWeight:'700'}}>ANUP KUMAR</p>
                                <p>I'm persuing my B.Tech degree in Computer Science and Engineering from one of the pretigious college of India VIT Bhopal and live in Bihar, India.</p>
                            </li>
                        </ul>
                    </div>
                    <div className='col-lg-3 mx-auto team'>
                    ...
                    <div className='col-lg-3'>
                        ...
                        <Form className='my-5'>
                            ...
                            <a href="mailto:sanskriti.gupta2020@vitbhopal.ac.in,anup94622@gmail.com" className='btn-get-started' role="button" aria-disabled="true">Submit</a>
                        </Form>
